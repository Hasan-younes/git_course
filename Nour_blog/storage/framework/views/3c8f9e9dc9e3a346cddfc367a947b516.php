<nav x-data="{ open: false }" class="bg-gray-700 dark:bg-gray-800 border-b border-gray-700 dark:border-gray-700">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.application-logo','data' => ['class' => 'block h-9 w-auto fill-current text-gray-100 dark:text-gray-200']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'block h-9 w-auto fill-current text-gray-100 dark:text-gray-200']); ?>
...
<?php endif; ?>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <a href="/blog" class=" text-gray-500 hover:text-gray-100 hover:underline px-6">Blog</a>
                <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
...
<?php /**PATH C:\xampp\htdocs\laravel_blog\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>