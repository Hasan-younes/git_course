        ...
        <header class="bg-gray-700 text-gray-100 py-6">
            <div class=" container mx-auto flex justify-end items-end py-2 px-6">
                <?php if(Route::has('login')): ?>
                    ...
                    <a href="<?php echo e(url('/')); ?>" class="font-semibold hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"><?php echo e(Auth::user()->name); ?></a>
...
<?php /**PATH C:\xampp\htdocs\Nour_blog\resources\views/home.blade.php ENDPATH**/ ?>